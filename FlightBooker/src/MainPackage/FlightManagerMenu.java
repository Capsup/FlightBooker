...
/**
 * A menu that the user can use in order to edit the passenger amount, the 
 * selected flight aswell as the passengers seats of a selected flight.
 * 
...
public class FlightManagerMenu
{
	...
	/**
	 * This class is initialized by passing it a frame to use, since it is not always
	 * created with a new JFrame. Since this menu is used in order to create new 
	 * reserations aswell as editing exsiting ones, we also need to pass it
	 * the reservation to use. The boolean passed defines whether the
	 * reservation should be uploaded to the database as a new
	 * or update an exsisting one.
	 * @param the frame that everything will be using
	 * @param the reservation to create or edit
	 * @param whether or not the reservation is new or not
	 */
	...
	class ButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			case "Flight Panel":
				...
				flightPanel = new FlightPanel(currentReservation.getFlight(), currentReservation, new Dimension(frameSize.width,(((frameSize.height/3*2)/4)*3)), true);
	 ...
	 * @param flight to make the panel from
	...
	/**
	 * initializeReservation method initializes the currentReservation. This is done since many of the methods used
	 * to change the reservation requires non-null instances of the different fields.
	 */
