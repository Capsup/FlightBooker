		...
		public void actionPerformed( ActionEvent e )
		{
			if( e.getActionCommand() == "OK" )
			{
				...
				if( nameTextField.getText().split( " " ).length > 1 )
				{
					...
					updatedPerson = new Person( sNameSplit[0], sSurName, genderTextField.getText(), birthTextField.getText(),
					        countryTextField.getText(), nationaTextField.getText(), adressTextField.getText(), phoneTextField.getText(),
					        passporTextField.getText(), person.getID() );
				}
				else
					updatedPerson = new Person( nameTextField.getText(), "", genderTextField.getText(), birthTextField.getText(),
					        countryTextField.getText(), nationaTextField.getText(), adressTextField.getText(), phoneTextField.getText(),
					        passporTextField.getText(), person.getID() );
