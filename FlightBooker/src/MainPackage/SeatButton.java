 ...
 * 
 * If the Seat is already booked, the SeatButton will be red. Non-booked seats will be the default color of a JButton. If the user clicks on a
 * SeatButton, it will become green, unless it is already booked.
 * 
...
public class SeatButton extends JButton
{
	 ...
	 * 
	 * @param The
	 *            Seat for which to make a button
	 * @param the
	 *            reservation of which the seat should check if it belongs
	 */
	 ...
	 * 
	 * @param the
	 *            passenger to recieve the seat from
	 */
	 ...
	 * 
	 * @param the
	 *            passenger to remove the seat from
	 */
