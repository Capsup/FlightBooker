...
public class FlightPanel extends JPanel 
{
	 ...
	 * 
	 * @param the flight to take data from
	 * @param the current reservation to identify
	 * @param the size of the panel
	 * @param whether or not the panel is editable
	 */
	 ...
	 * @param The x position that the button shall be initialized on
	 * @param The y position that the button shall be initialized on
	 * @param The panel for which the seat button shall be attatched.
