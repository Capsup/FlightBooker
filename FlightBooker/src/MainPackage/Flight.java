...
public class Flight implements Serializable, Uploadable
{
	 ...
	 * 
	 * @param reservations
	 *            the reservations to be set for the Flight
	 */
	 ...
	 * 
	 * @param index
	 *            The index of the Reservation to be replaced
	 * @param reservation
	 *            The Reservation to replace the current Reservation
	 */
	 ...
	 * 
	 * @param index
	 *            the index of the Reservation to remove.
	 */
	public void removeReservationAt( int index )
	{
		...
		// Moves all of the Flight's Reservations in the array to overwrite the Reservation to be removed and compensating for the lack of the removed
		// Reservation
